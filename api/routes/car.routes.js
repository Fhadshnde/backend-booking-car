...
router.put("/:id", protect, restrictTo("admin", "company"), uploadCarImages, validate(updateCarSchema), updateCar);
router.delete("/:id", protect, restrictTo("admin", "company"), deleteCar);
